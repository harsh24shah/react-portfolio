              ...
              <div className={'social-media-logos ' + this.toggleMenu}>
                <div className='inline-block my-12'>
                  <span className='mr-20'>
                    <a title='Opens in a new tab' href='https://github.com/harsh24shah' rel='noopener noreferrer' target='_blank' className='hover-this'><IoLogoGithub size='30px' /></a>
                  </span>
                  <span className='mr-20'>
                    <a title='Opens in a new tab' href='https://www.linkedin.com/in/24hjs' rel='noopener noreferrer' target='_blank' className='hover-this'><IoLogoLinkedin size='30px' /></a>
                  </span>
                  <span className='mr-20'>
                    <a title='Opens in a new tab' href='https://www.facebook.com/24hjs' rel='noopener noreferrer' target='_blank' className='hover-this'><IoLogoFacebook size='30px' /> </a>
                  </span>
                  <span className='mr-20'>
                    <a title='Opens in a new tab' href='https://www.instagram.com/24harsh' rel='noopener noreferrer' target='_blank' className='hover-this'><AiFillInstagram size='30px' /></a>
                  </span>
                </div>
              </div>
            </header>
