        ...
        <div className='box-wrapper' data-sal='slide-up' data-sal-delay='500' data-sal-easing='ease'>
          <div className='padding-box'>
            ...
            <div className='inline-block my-12'>
              ...
              <span className='mr-20'><a href='https://www.instagram.com/harshjshahh' rel='noopener noreferrer' target='_blank' className='hover-this'><IoLogoInstagram size='30px' /></a></span>
            </div>
          </div>
        </div>
      </div>
