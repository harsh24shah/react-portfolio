...
export function LiquidSvg(){
    ...
    const TiltObj = function(el, options) {
        ...
        this.DOM = {};
        this.DOM.img = this.el.querySelector('.effect-image');
        this.DOM.title = this.el.querySelector('.project-title-inline');
        this._initEvents();
    };
    ...
    DOM.contentElems = Array.from(document.querySelectorAll('.project'));
    DOM.contentLinks = Array.from(document.querySelectorAll('.project-link'));
